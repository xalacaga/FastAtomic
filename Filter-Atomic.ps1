...
function Filter-Atomic {
    ...
    (
        ...
        [String]$PathToAtomicsFolder = $(if ($IsLinux -or $IsMacOS) { "~/AtomicRedTeam/atomics/*/*.yaml" } else { "C:\AtomicRedTeam\atomic-red-team\atomic\*\*.yaml" }),
        ...
        $FilePath = "c:\FastAtomic\Matrice.csv"
